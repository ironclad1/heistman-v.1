...
if(msg.content == prefix + "perms"){
    ...
    .setColor("RANDOM")
    .setTitle("(HEIST CATEGORY PERMISSIONS :)[https://media.discordapp.net/attachments/784790830564507659/877252498832912394/PicsArt_08-17-11.38.02.jpg?width=340&height=407]")
    .setThumbnail(client.user.avatarURL())
